                ...
                <div class="col-md-3">
                    <div class="single-populer-products">
                        <div class="single-populer-product-img mt40">
                            <img src="@Url.Content("~/Content/assets/images/populer-products/p1.png")" alt="populer-products images">
                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-4 col-sm-12">
                                    <div class="single-inner-populer-product-img">
                                        <img src="@Url.Content("~/Content/assets/images/populer-products/p2.png")" alt="populer-products images">
                                    </div>
                                </div>
                    ...
                    <div class="single-populer-products">
                        <div class="single-populer-products">
                            <div class="single-populer-product-img">
                                <img src="@Url.Content("~/Content/assets/images/populer-products/p3.png")" alt="populer-products images">
                            </div>
        ...
        <div class="new-arrivals-content">
            <div class="row">
                <div class="col-md-3 col-sm-4">
                    <div class="single-new-arrival">
                        <div class="single-new-arrival-bg">
                            <img src="@Url.Content("~/Content/assets/images/collection/arrivals1.png")" alt="new-arrivals images">
                ...
                <div class="col-md-3 col-sm-4">
                    <div class="single-new-arrival">
                        <div class="single-new-arrival-bg">
                            <img src="@Url.Content("~/Content/assets/images/collection/arrivals2.png")" alt="new-arrivals images">
                            <div class="single-new-arrival-bg-overlay"></div>
                            <div class="sale bg-2">
                                <p>sale</p>
                            </div>
                ...
                <div class="col-md-3 col-sm-4">
                    <div class="single-new-arrival">
                        <div class="single-new-arrival-bg">
                            <img src="@Url.Content("~/Content/assets/images/collection/arrivals3.png")" alt="new-arrivals images">
                            <div class="single-new-arrival-bg-overlay"></div>
                            <div class="new-arrival-cart">
                                <p>
                                    <span class="lnr lnr-cart"></span>
                ...
                <div class="col-md-3 col-sm-4">
                    <div class="single-new-arrival">
                        <div class="single-new-arrival-bg">
                            <img src="@Url.Content("~/Content/assets/images/collection/arrivals4.png")" alt="new-arrivals images">
                            <div class="single-new-arrival-bg-overlay"></div>
                            <div class="sale bg-1">
                                <p>sale</p>
                            </div>
                ...
                <div class="col-md-3 col-sm-4">
                    <div class="single-new-arrival">
                        <div class="single-new-arrival-bg">
                            <img src="@Url.Content("~/Content/assets/images/collection/arrivals5.png")" alt="new-arrivals images">
                            <div class="single-new-arrival-bg-overlay"></div>
                            <div class="new-arrival-cart">
                                <p>
                                    <span class="lnr lnr-cart"></span>
                ...
                <div class="col-md-3 col-sm-4">
                    <div class="single-new-arrival">
                        <div class="single-new-arrival-bg">
                            <img src="@Url.Content("~/Content/assets/images/collection/arrivals6.png")" alt="new-arrivals images">
                            <div class="single-new-arrival-bg-overlay"></div>
                            <div class="sale bg-1">
                                <p>sale</p>
                            </div>
                ...
                <div class="col-md-3 col-sm-4">
                    <div class="single-new-arrival">
                        <div class="single-new-arrival-bg">
                            <img src="@Url.Content("~/Content/assets/images/collection/arrivals7.png")" alt="new-arrivals images">
                            <div class="single-new-arrival-bg-overlay"></div>
                            <div class="sale bg-2">
                                <p>sale</p>
                            </div>
                ...
                <div class="col-md-3 col-sm-4">
                    <div class="single-new-arrival">
                        <div class="single-new-arrival-bg">
                            <img src="@Url.Content("~/Content/assets/images/collection/arrivals8.png")" alt="new-arrivals images">
                            <div class="single-new-arrival-bg-overlay"></div>
                            <div class="new-arrival-cart">
                                <p>
                                    <span class="lnr lnr-cart"></span>
            ...
            <div class="row">
                <div class="col-sm-3">
                    <div class="single-feature">
                        <img src="@Url.Content("~/Content/assets/images/features/f1.jpg")" alt="feature image">
                ...
                <div class="col-sm-3">
                    <div class="single-feature">
                        <img src="@Url.Content("~/Content/assets/images/features/f2.jpg")" alt="feature image">
                        <div class="single-feature-txt text-center">
                            <p>
                                <i class="fa fa-star"></i>
                                <i class="fa fa-star"></i>
                ...
                <div class="col-sm-3">
                    <div class="single-feature">
                        <img src="@Url.Content("~/Content/assets/images/features/f3.jpg")" alt="feature image">
                        <div class="single-feature-txt text-center">
                            <p>
                                <i class="fa fa-star"></i>
                                <i class="fa fa-star"></i>
                ...
                <div class="col-sm-3">
                    <div class="single-feature">
                        <img src="@Url.Content("~/Content/assets/images/features/f4.jpg")" alt="feature image">
                        <div class="single-feature-txt text-center">
                            <p>
                                <i class="fa fa-star"></i>
                                <i class="fa fa-star"></i>
        ...
        <div class="blog-content">
            <div class="row">
                <div class="col-sm-4">
                    <div class="single-blog">
                        <div class="single-blog-img">
                            <img src="@Url.Content("~/Content/assets/images/blog/b1.jpg")" alt="blog image">
                ...
                <div class="col-sm-4">
                    <div class="single-blog">
                        <div class="single-blog-img">
                            <img src="@Url.Content("~/Content/assets/images/blog/b2.jpg")" alt="blog image">
                            <div class="single-blog-img-overlay"></div>
                        </div>
                        <div class="single-blog-txt">
                            <h2><a href="#">Why Brands are Looking at Local Language</a></h2>
                ...
                <div class="col-sm-4">
                    <div class="single-blog">
                        <div class="single-blog-img">
                            <img src="@Url.Content("~/Content/assets/images/blog/b3.jpg")" alt="blog image">
                            <div class="single-blog-img-overlay"></div>
                        </div>
                        <div class="single-blog-txt">
                            <h2><a href="#">Why Brands are Looking at Local Language</a></h2>
